...
# --- PAGE CONFIG ---
st.set_page_config(
    page_title="Production Grade Agentic RAG",
    page_icon="🤖",
    layout="wide",
)
...
# --- MAIN CHAT ---
st.title("🤖 Production Grade Agentic Assistant")
...
# Chat Input
if prompt := st.chat_input("Ask about your questions about the documentation..."):
        ...
        with st.chat_message("assistant", avatar=AI_AVATAR):
            with st.status("🔍 Agent is thinking...", expanded=True) as status:
                try:
                    ...
                    print(f"Backend Response: {data}")  # Debugging line to print the backend response
